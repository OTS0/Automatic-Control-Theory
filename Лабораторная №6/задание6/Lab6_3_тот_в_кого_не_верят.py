...
def movement():
    ...
    data.append([time_now, angle - start_angle, speed - start_speed, U, e, e_delay])
    str_data = ",".join(list(map(str, data[-1])))
...
try:
    ...
    for omega1 in range(20):
        ...
        while (time_now < 2):  # Запускаем моторчик и записываем данные с него в течение 5 секунд
            movement()
