...
if os.path.exists('/home/robot/task2.2c'):#проверяет есть ли такой путь
    shutil.rmtree('/home/robot/task2.2c') #удаление папки

os.makedirs('/home/robot/task2.2c')#cоздание папки
file = '/home/robot/task2.2c/task2.2c_k_p=' + k_p
f=open(file, "a")
